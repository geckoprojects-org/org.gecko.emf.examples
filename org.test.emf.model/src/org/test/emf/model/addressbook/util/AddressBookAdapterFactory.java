...
public class AddressBookAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected AddressBookPackage modelPackage;
	 ...
	 * @generated
	 */
	public AddressBookAdapterFactory(AddressBookPackage modelPackage) {
	...
	protected AddressBookSwitch<Adapter> modelSwitch =
		new AddressBookSwitch<Adapter>(modelPackage) {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.test.emf.model.addressbook.AddressBook <em>Address Book</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.test.emf.model.addressbook.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.test.emf.model.addressbook.Contact <em>Contact</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
