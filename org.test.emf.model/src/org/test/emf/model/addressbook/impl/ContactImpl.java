 ...
 * </p>
 * <ul>
 *   <li>{@link org.test.emf.model.addressbook.impl.ContactImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.test.emf.model.addressbook.impl.ContactImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.test.emf.model.addressbook.impl.ContactImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContactImpl extends MinimalEObjectImpl.Container implements Contact {
	 ...
	 * @ordered
	 */
	protected static final ContactType TYPE_EDEFAULT = ContactType.UNKOWN;
	 ...
	 * @generated
	 */
	protected ContactImpl(EClass instanceEClass) {
		super();
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressBookPackage.CONTACT__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AddressBookPackage.CONTACT__ID:
				return getId();
